...
const changedInfo = {
  businessName: "Nikki Lux 8888",
  businessAddressLevel1: "78 Green Lanes",
  businessAddressLevel2: "Harringay",
  ...
  businessPostCode: "N4 1DX",


  businessPhoneNumber: "07938888868",
  ...
  geoLatitude: 51.57747109752705,
  geoLongitude: -0.09862974818593068,

  //Code xác minh của website trên Google Search
  metaGoogleSiteVerification: "8PY9C4tyFxx-C0abTprXegCqjI9VHTxWzt57enQ1cNc",

  //iframe map
  iframeMapLink: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1239.7567942677904!2d-0.09981645703771856!3d51.5771499556405!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48761bd87108f697%3A0x37d9846695795739!2sNikki%20Lux%208888!5e0!3m2!1sen!2s!4v1723015952722!5m2!1sen!2s",

  // Các ảnh của tiệm
  ogImage: "https://nikkilux8888.web.app/images/desktop-nail-salon-happy-customer-1.jpg",
  icon: "/icon.jpg",
...
const schemaInput = {
  ...
  schemaPriceRange: "££",
  //Cần đổi tên khách
  schemaPersonReviewAuthorName: "Petra Natalina",
  //Xem điểm review trung bình của tiệm là bao nhiêu
  schemaRatingValue: "5",
  schemaBestRating: "5",

  schemaGeoLatitude: 51.57747109752705,
  schemaLongitude: -0.09862974818593068,
...
const serviceList1 = {
  ...
  service49: "Take off Acrylic",
  service49Time: "15 mins",
  service49Price: "12",
  service49Description: "Say hello to a refreshed and rejuvenated look for your nails. Our expert technicians will gently remove your old acrylic, leaving your nails feeling revitalized. Embrace the love and care you deserve with our gentle, yet effective, process.",

  service50: "Shellac & 2 Big Toes Acrylic",
  service50Time: "20 mins",
  service50Price: "33",
  service50Description: "",

  service51: "Fullset Gel Polish on Hand",
  service51Time: "20 mins",
  service51Price: "35",
  service51Description: "",

  service52: "Fullset Gel Polish on Feet",
  service52Time: "20 mins",
  service52Price: "45",
  service52Description: "",

  service53: "Infill Gel Polish on Hand",
  service53Time: "20 mins",
  service53Price: "28",
  service53Description: "",

  service54: "Infill Gel Polish on Feet",
  service54Time: "20 mins",
  service54Price: "38",
  service54Description: "",

  service55: "Take off Acrylic + Manicure",
  service55Time: "50 mins",
  service55Price: "22",
  service55Description: "",

  service56: "Colour Tips (from)",
  service56Time: "15 mins",
  service56Price: "5",
  service56Description: "",

  service57: "One Big Toes Acrylic",
  service57Time: "15 mins",
  service57Price: "5",
...
const serviceList2 = {
  ...
  service8: "Take off Shellac (Hand)",
  ...
  service11: "Take off Shellac (Feet)",
...
const serviceList3 = {
  ...
  service6: "Shape & paint on hands (Normal Polish)",
  ...
  service7: "Shape & paint on toes (Normal Polish)",
